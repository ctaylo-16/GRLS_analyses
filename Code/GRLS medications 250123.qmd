...
```{r}
duration_dict <- list(
  "0.03" = c("1 days","1 not applicable"),
  "0.06"="2 days",
  "0.09"="3 days",
  "0.12" = "4 days",
  "0.17"="5 days",
...
#write this to csv 
medications_mapped <- as.data.frame(medications_mapped)

write.csv(medications_mapped,here::here("Output/GRLS_medications_initial_tidy.csv"),row.names = FALSE, fileEncoding = "UTF-8")
