...
neoplasia<-read.csv(here::here("Data/conditions_neoplasia.csv"),na.strings=c ("", "NA"))
#end_points <- read.csv(file="Data/study_endpoints.csv")
end_points <- read.csv(file=here::here("Data/study_endpoints.csv"),na.strings=c ("", "NA"))
```
...
write.csv(neoplasia_at_death, here::here("Data/GRLS_neoplasia_at_death.csv"))
...
write.csv(neoplasia_death,here::here("Data/GRLS_neoplasia_death.csv"))
...
#164 dogs
write.csv(non_neoplastic_death,here::here("Data/GRLS_non_neoplasia_death.csv"))
...
medications <- read_csv(file=here::here("Data/medications.csv"))
...
```{r}
#load in medications dataset and explore
vaccinations <- read_csv(file=here::here("Data/vaccines.csv"))
...
repro_hx_female <- read.csv(here::here("Data/reproductive_history_female.csv"),na.strings=c ("", "NA"))
repro_hx_female <- repro_hx_female %>% mutate(across(where(is.character), tolower))
#female heats
repro_heats_female <- read.csv(here::here("Data/reproductive_history_heat.csv"),na.strings=c ("", "NA"))
repro_heats_female <- repro_heats_female %>% mutate(across(where(is.character), tolower))
#male neutering and breeding info
repro_hx_male <- read.csv(here::here("Data/reproductive_history_male.csv"),na.strings=c ("", "NA"))
repro_hx_male <- repro_hx_male %>% mutate(across(where(is.character), tolower))
#hormone therapy
repro_hx_hormones <-read.csv(here::here("Data/reproductive_history_hormones.csv"),na.strings=c ("", "NA"))
...
```{r}
poisons <- read_csv(file=here::here("Data/poison_exposure.csv"))
...
```{r}
#travel locations
location_history <- read.csv(here::here("Data/location_history.csv"),na.strings=c ("","NA"))
...
```{r}
enviro_time <- read.csv(here::here("Data/environment_spend_time_location.csv"),na.strings=c("","NA"))
...
```{r}
enviro_sleep <- read.csv(here::here("Data/environment_sleep_location.csv"),na.strings=c("","NA"))
...
```{r}
activity_time <- read.csv(here::here("Data/activity_overview.csv"),na.strings=c("","NA"))
...
```{r}
wash_time <- read.csv(here::here("Data/wash_groom.csv"),na.strings=c("","NA"))
