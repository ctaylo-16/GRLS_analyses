...
FIPS <- read.csv(here::here("Data/uszips.csv"))
FIPS <- FIPS %>%
...
```{r}
MDI_2019 <- read.csv(here::here("Data/MDI_2019.csv"))
MDI_2019 <- MDI_2019 %>%
...
write.csv(clinics_and_fips2_mdi,here::here("Output/GRLS_dogs_MDI_2019.csv"))
```
