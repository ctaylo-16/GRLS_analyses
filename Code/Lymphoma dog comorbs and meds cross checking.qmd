...
comorbs_all <-read.csv(here::here("Output/all_cohort_all_comorbs_ever.csv"))
...
```{r}
write.csv(lymphoma_comorbs_with_rp2,here::here("Output/GRLS_lymphoma_plus_records_comorbs3.csv"))
```

Do counts for manual crosschecking now

```{r}
records_crosschecked <- read.csv(here::here("Output/GRLS_lymphoma_plus_records_comorbs3_annotated.csv"))
...
```{r}
meds_endpoints_5y<-read.csv(here::here("Output/GRLS_endpoints_5y_prior_medications.csv"))
...
write.csv(lymphoma_meds_with_rp2,here::here("Output/GRLS_lymphoma_plus_records_medications.csv"))
```

Cross-check counting

```{r}
lymphoma_meds_annotated<-read.csv(here::here("Output/GRLS_lymphoma_plus_records_medications_annotated.csv"))
