...
write.csv(activity_all_2, here::here("Output/GRLS_activity_modified_variables.csv"))
```
...
write.csv(activity_all_3_3, here::here("Output/GRLS_activity_modified_variables_one_row_per_dog.csv"))
```
