...
end_points_neoplasia <- read.csv(here::here("Data/study_endpoints.csv"))
...
write.csv(HSA_sleep_smoking_enviro_all,here::here("Data/HSA_case_enviro.csv"))
```
...
```{r}
write.csv(HSA_sleep_smoking_enviro__lifestyle_all,here::here("Output/HSA_case_sleep_smoking_enviro_lifestyle.csv"))
