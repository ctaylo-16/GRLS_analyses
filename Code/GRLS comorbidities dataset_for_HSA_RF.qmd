...
Now retaining single row per dog

```{r}
HSA_distinct <- HSA_comorbs_unique4 %>%
    distinct(subject_id,.keep_all = TRUE)


write.csv(HSA_distinct,"C:/Users/ctaylor18/GitHub/GRLS_analyses/Output/HSA_cohort_comorbs_with_HSA_final_date_calculations.csv")
```
