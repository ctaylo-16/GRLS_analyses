...
HSA<- read.csv(here::here("Output/HSA_study_pop_with_final_date_with_final_study_record_year.csv"))
...
```{r}
write.csv(endpoints_comorbs_2,here::here("Output/endpoint_comorbidities.csv"))
```
...
```{r}
write.csv(df_result7,here::here("Output/all_records_comorbidities.csv"))
```
...
write.csv(HSA_comorbs_unique4_df7_distinct,here::here("Output/HSA_cohort_comorbs_with_HSA_final_date_calculations.csv"))
...
write.csv(HSA_comorbs_unique4_df7_distinct_abr,here::here("Output/HSA_cohort_comorbs_incl_cancer.csv"))

write.csv(HSA_comorbs_unique4_df7_distinct,here::here("Output/HSA_cohort_comorbs_incl_cancer_all_cols.csv"))
```
...
write.csv(whole_cohort_abr_unique2,here::here("Output/all_cohort_all_comorbs_ever.csv"))
```
