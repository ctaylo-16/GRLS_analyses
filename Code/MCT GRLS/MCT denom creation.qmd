...
```{r}
library(tidyverse)
dog_profile <- read.csv(here::here("Data/dog_profile_for_MCT.csv"))
endpoint<-read.csv(here::here("Data/study_endpoints_MCT.csv"))
...
```{r}
write.csv(dates_and_MCT_diagnosis,here::here("Output/MCT_cohort_250531.csv"))
```
