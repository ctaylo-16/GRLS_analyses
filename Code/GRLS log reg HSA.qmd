...
cols_to_modify <- 198:264  # replace with your actual column indices
...
model_6b<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + mode_purina_BCS_5y_prior_endpoint, data = cohort_abr_sig, family = binomial)
summary(model_6b)
...
```{r}
model_7<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life, data = cohort_abr_sig, family = binomial)
summary(model_7)
...
```{r}
model_8a<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint, data = cohort_abr_sig, family = binomial)
...
```{r}
model_9<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint+ main_lifestyle_category_mode_5yrs_prior, data = cohort_abr_sig, family = binomial)
summary(model_9)
...
```{r}
model_10a<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint + malig_cancers_YN_no_HSA, data = cohort_abr_sig, family = binomial)
summary(model_10a)
...
model_10b<- glm(had_HSA ~ age_at_final_date_GB  + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint + malig_cancers_YN_no_HSA, data = cohort_abr_sig, family = binomial)
summary(model_10b)
logistic.display(model_10b)

model_10c<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint , data = cohort_abr_sig, family = binomial)
summary(model_10c)
logistic.display(model_10c)


model_10d<- glm(had_HSA ~ age_at_final_date_GB  +malig_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint , data = cohort_abr_sig, family = binomial)
summary(model_10d)
...
```{r}
model_11<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint + fenbendazole_ever, data = cohort_abr_sig, family = binomial)
...
```{r}
model_12<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever, data = cohort_abr_sig, family = binomial)
...
```{r}
model_13<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + heats_before_neutering_terciles, data = cohort_abr_sig, family = binomial)
...
```{r}
model_14<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + heats_before_neutering_terciles + heating_fuel_primary_mode_5yrs_prior, data = cohort_abr_sig, family = binomial)
...
```{r}
model_15<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + heats_before_neutering_terciles + any_treated_insects_study_years_rest_of_life, data = cohort_abr_sig, family = binomial)
...
```{r}
model_18<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + heats_before_neutering_terciles +  gastrointestinal, data = cohort_abr_sig, family = binomial)
...
```{r}
model_19<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + heats_before_neutering_terciles + gastrointestinal + age_at_neuter_years_quartiles, data = cohort_abr_sig, family = binomial)
...
```{r}
model_21<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + heats_before_neutering_terciles  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles, data = cohort_abr_sig, family = binomial)
...
```{r}
#ever
model_23a<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + heats_before_neutering_terciles + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles , data = cohort_abr_sig, family = binomial)
summary(model_23a)
#5y
model_23b<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_5y + heats_before_neutering_terciles  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles , data = cohort_abr_sig, family = binomial)
summary(model_23b)
```
...
```{r}
model_25<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex, data = cohort_abr_sig, family = binomial)
summary(model_25)
logistic.display(model_25)
model_25a<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever +  gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + heats_before_neutering_terciles, data = cohort_abr_sig, family = binomial)
...
```{r}
model_27<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter, data = cohort_abr_sig, family = binomial)
summary(model_27)
...
```{r}
model_28<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever +  gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + half_enteric_5y_prior_endpoint, data = cohort_abr_sig, family = binomial)
summary(model_28)
...
```{r}
model_29<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + avg_height_5y_prior_endpoint_quartiles, data = cohort_abr_sig, family = binomial)
summary(model_29)
...
```{r}
model_31<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever +  gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + number_comorbs_present_lifetime, data = cohort_abr_sig, family = binomial)
summary(model_31)
...
```{r}
model_32<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + outside_YN_study_years_early_life, data = cohort_abr_sig, family = binomial)
summary(model_32)
...
```{r}
model_33<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + fenbendazole_5y, data = cohort_abr_sig, family = binomial)
summary(model_33)
...
```{r}
model_35<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + number_comorbs_present_5y, data = cohort_abr_sig, family = binomial)
summary(model_35)
...
```{r}
model_37<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + use_incense_or_candles_study_years_rest_of_life, data = cohort_abr_sig, family = binomial)
summary(model_37)
...
```{r}
model_38<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + chronic_inflammatory, data = cohort_abr_sig, family = binomial)
summary(model_38)
...
```{r}
model_39<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever +  gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + avg_purina_BCS_5y_prior_endpoint_quartiles, data = cohort_abr_sig, family = binomial)
summary(model_39)
...
```{r}
model_40<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever +   gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + lifelong_chronic_inflammatory, data = cohort_abr_sig, family = binomial)
summary(model_40)
...
```{r}
model_41<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + chronic_inflam_present.x, data = cohort_abr_sig, family = binomial)
summary(model_41)
...
```{r}
model_42<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life, data = cohort_abr_sig, family = binomial)
summary(model_42)
...
```{r}
model_43<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life+ all_parasitism, data = cohort_abr_sig, family = binomial)
summary(model_43)
...
```{r}
model_45<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever +   gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter +smoke_exposure_study_years_early_life+ majority_sleep_location_lifetime, data = cohort_abr_sig, family = binomial)
summary(model_45)
...
```{r}
#duration sy1_2
model_47<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter +smoke_exposure_study_years_early_life+ avg_activity_duration_sy1_2_splits, data = cohort_abr_sig, family = binomial)
summary(model_47)
logistic.display(model_47)
car::vif(model_47)
lrtest(model_42,model_47)
#freq sy3
model_47a<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever +  gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life + avg_activity_freq_sy3_splits, data = cohort_abr_sig, family = binomial)
summary(model_47a)
...
model_47b<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter +smoke_exposure_study_years_early_life, data = cohort_abr_sig, family = binomial)
summary(model_47b)
...
```{r}
#melanoma
model_48a<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life + melanoma_present, data = cohort_abr_sig, family = binomial)
summary(model_48a)
...
#lymphoma
model_48b<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever +  gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life + lymphoma_present, data = cohort_abr_sig, family = binomial)
summary(model_48b)
logistic.display(model_48b)
car::vif(model_48b)
lrtest(model_42,model_48b) 
#MCT
model_48c<- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life + mast_cell_tumor_present, data = cohort_abr_sig, family = binomial)
summary(model_48c)
...
model_48d<- glm(had_HSA ~ age_at_final_date_GB  + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life + mast_cell_tumor_present + melanoma_present, data = cohort_abr_sig, family = binomial)
summary(model_48d)
logistic.display(model_48d)
car::vif(model_48d)

#assess if models better with the cancer count or the presence of MCT or melanoma
model_cancer_count <- glm(had_HSA ~ age_at_final_date_GB  +all_cancers_count_no_HSA + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever  + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life + all_cancers_count_no_HSA, data = cohort_abr_sig, family = binomial)
summary(model_cancer_count)

model_melanoma <- glm(had_HSA ~ age_at_final_date_GB  + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever +   gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life  +melanoma_present, data = cohort_abr_sig, family = binomial)
...
```{r}
model_f<- glm(had_HSA ~ age_at_final_date_GB  + avg_frequency_5y_prior_endpoint_quartile + any_treated_fertilizer_study_years_whole_life + quartile_anti_parasites_5y_prior_endpoint  +NSAID_ever + gastrointestinal + avg_weight_5y_prior_endpoint_quartiles + sex + neuter + smoke_exposure_study_years_early_life + mast_cell_tumor_present, data = cohort_abr_sig, family = binomial)
summary(model_f)
...
plot2 <-cohort_abr_sig %>%
  or_plot(dependent, explanatory,column_space = c(-0.5, -0.1, 0.5),table_text_size = 3, plot_opts = list(xlim(0, 11)))
plot2
print(plot2)
```
...
```{r}
model_freq<- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile, data=cohort_abr_sig_5y,family=binomial)
...
#freq splits
model_freq2<- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_splits, data=cohort_abr_sig_5y,family=binomial)


summary(model_freq2)
logistic.display(model_freq2)
car::vif(model_freq2)
lrtest(model_cancer1,model_freq2)

model_int<- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA +  avg_intensity_5y_prior_endpoint_quartile, data=cohort_abr_sig_5y,family=binomial)
...
```{r}
model_weed<- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile +any_treated_weeds_exposed_5yrs_prior, data=cohort_abr_sig_5y,family=binomial)
...
```{r}
model_fert<- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile +any_treated_weeds_exposed_5yrs_prior + any_treated_fertilizer_exposed_5yrs_prior, data=cohort_abr_sig_5y,family=binomial)
...
```{r}
model_a<- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile +any_treated_weeds_exposed_5yrs_prior + NSAID_5y, data=cohort_abr_sig_5y,family=binomial)
...
model_a1<- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile + NSAID_5y, data=cohort_abr_sig_5y,family=binomial)
```
...
```{r}
model_b1 <- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y + half_anti_inflam_5y_prior_endpoint, data=cohort_abr_sig_5y,family=binomial)
...
model_b2 <- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y +  quartile_anti_inflam_5y_prior_endpoint, data=cohort_abr_sig_5y,family=binomial)
...
```{r}
model_c1 <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + half_immunologicals_5y_prior_endpoint, data=cohort_abr_sig_5y,family=binomial)
...
model_c2 <- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y + quartile_immunologicals_5y_prior_endpoint, data=cohort_abr_sig_5y,family=binomial)
...
```{r}
model_d <- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y + half_anti_parasites_5y_prior_endpoint, data=cohort_abr_sig_5y,family=binomial)
...
```{r}
#sex
model_e1 <- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex, data=cohort_abr_sig_5y,family=binomial)
...
#sex neut
model_e2 <- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter, data=cohort_abr_sig_5y,family=binomial)
...
model_e3 <- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + neuter, data=cohort_abr_sig_5y,family=binomial)
...
model_f <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + region_mode_5y_prior, data=cohort_abr_sig_5y,family=binomial)
summary(model_f)
logistic.display(model_f)
car::vif(model_f)
...
model_g <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + age_at_neuter_years_quartile, data=cohort_abr_sig_5y,family=binomial)
summary(model_g)
...
```{r}
model_h <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + half_dietary_supplements_5y_prior_endpoint, data=cohort_abr_sig_5y,family=binomial)
summary(model_h)
...
```{r}
model_i <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + fenbendazole_5y, data=cohort_abr_sig_5y,family=binomial)
summary(model_i)
...
model_i2 <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile   + sex_neuter + fenbendazole_5y, data=cohort_abr_sig_5y,family=binomial)
summary(model_i2)
...
```{r}
model_j <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + main_lifestyle_category_mode_5yrs_prior, data=cohort_abr_sig_5y,family=binomial)
summary(model_j)
...
```{r}
model_k <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + half_anti_microbials_5y_prior_endpoint, data=cohort_abr_sig_5y,family=binomial)
summary(model_k)
...
```{r}
model_l <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + avg_purina_BCS_5y_prior_endpoint_quartile, data=cohort_abr_sig_5y,family=binomial)
summary(model_l)
...
```{r}
model_m <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + lifelong_comorb_present.x, data=cohort_abr_sig_5y,family=binomial)
summary(model_m)
...
```{r}
model_n <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + chronic_inflammatory, data=cohort_abr_sig_5y,family=binomial)
summary(model_n)
...
```{r}
model_o <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + inflammatory_other, data=cohort_abr_sig_5y,family=binomial)
summary(model_o)
...
```{r}
model_p <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + all_parasitism, data=cohort_abr_sig_5y,family=binomial)
summary(model_p)
...
```{r}
model_q <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + steroid_5y, data=cohort_abr_sig_5y,family=binomial)
summary(model_q)
...
```{r}
model_r <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + number_comorbs_present_5y, data=cohort_abr_sig_5y,family=binomial)
summary(model_r)
...
```{r}
model_s <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + use_hepa_filter_exposed_5yrs_prior, data=cohort_abr_sig_5y,family=binomial)
summary(model_s)
...
```{r}
model_t <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + use_hepa_filter_exposed_5yrs_prior, data=cohort_abr_sig_5y,family=binomial)
summary(model_t)
...
```{r}
model_u <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + mode_purina_BCS_5y_prior_endpoint, data=cohort_abr_sig_5y,family=binomial)
summary(model_u)
...
```{r}
model_v<- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + avg_height_5y_prior_endpoint_quartile, data=cohort_abr_sig_5y,family=binomial)
summary(model_v)
...
```{r}
model_w <- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + heating_fuel_primary_mode_5yrs_prior, data=cohort_abr_sig_5y,family=binomial)
summary(model_w)
...
Presence of cancer types - melanoma, mct, lymphoma at univar - all sig but lymphoma only for not recorded level -

```{r}
#melanoma
model_48a<- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + melanoma_present, data=cohort_abr_sig_5y  ,  family = binomial)
summary(model_48a)
logistic.display(model_48a)
car::vif(model_48a)
lrtest(model_e2,model_48a) 


#lymphoma
model_48b<- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + lymphoma_present, data=cohort_abr_sig_5y  ,  family = binomial)
summary(model_48b)
logistic.display(model_48b)
car::vif(model_48b)
lrtest(model_e2,model_48b) 
#MCT
model_48c<- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + mast_cell_tumor_present, data=cohort_abr_sig_5y  , family = binomial)
summary(model_48c)
logistic.display(model_48c)
car::vif(model_48c)
lrtest(model_e2,model_48c) 


#assess if MCT and melanoma can be in model together and also if better to have these variables or cancer count - cannot have both in 
model_48d<- glm(had_HSA ~age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter +  mast_cell_tumor_present + melanoma_present, data = cohort_abr_sig_5y, family = binomial)
summary(model_48d)
logistic.display(model_48d)
car::vif(model_48d)

#assess if models better with the cancer count or the presence of MCT or melanoma
model_cancer_count <- glm(had_HSA ~ age_at_final_date_GB + all_cancers_YN_no_HSA + avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter , data = cohort_abr_sig, family = binomial)
summary(model_cancer_count)

model_melanoma <- glm(had_HSA ~ age_at_final_date_GB +  avg_frequency_5y_prior_endpoint_quartile  + NSAID_5y  + sex_neuter + +melanoma_present, data = cohort_abr_sig, family = binomial)
summary(model_melanoma)
car::vif(model_melanoma)
```

Final model output with time restricted variables: H&L p=0.07 Cstatistics 0.78

```{r}
dependent <- "had_HSA"
explanatory <- c("age_at_final_date_GB","sex_neuter","mast_cell_tumor_present","avg_frequency_5y_prior_endpoint_quartile","NSAID_5y")
...
plot2 <-cohort_abr_sig_5y %>%
  or_plot(dependent, explanatory,column_space = c(-0.5, -0.1, 0.5),table_text_size = 3, plot_opts = list(xlim(0, 9)))
plot2
print(plot2)
```
...
dependent <- "had_HSA"
explanatory <- c("age_at_final_date_GB","sex_neuter","avg_weight_5y_prior_endpoint_quartiles","mast_cell_tumor_present","gastrointestinal","quartile_anti_parasites_5y_prior_endpoint","NSAID_ever","avg_frequency_5y_prior_endpoint_quartile","smoke_exposure_study_years_early_life")
final_model_table <-cohort_abr_sig %>% 
  finalfit(dependent, explanatory, metrics = TRUE,column=TRUE) %>%
  kable(format = "html", digits = 2, escape = FALSE) %>%
  kable_styling(full_width = FALSE, bootstrap_options = c("striped", "hover"))
...
df <- df %>%
mutate(
    mast_cell_tumor_present = recode(as.character(mast_cell_tumor_present),
                          "0" = "MCT not present",
                          "1" = "MCT present",
                          "did_not_have_endpoint_data" = "No endpoint data available")
)
    
df <- df %>%   
  mutate(mast_cell_tumor_present = factor(mast_cell_tumor_present,levels=c(
    "MCT not present","MCT present","No endpoint data available"
  )))
...
df <- df %>%   
  mutate(NSAID_ever = factor(NSAID_ever,levels=c(
...
df <- df %>%
  mutate(
    avg_frequency_5y_prior_endpoint_quartile = recode(as.character(avg_frequency_5y_prior_endpoint_quartile),
      "≥20 - <71.67" = "Q1(≥20 - <71.67)",
      "≥71.67 - <80" = "Q2(≥71.67 - <80)",
      "≥80 - <85" = "Q3(≥80 - <85)",
      "≥85 - <100" = "Q4(≥85 - <100)",
      "not_recorded" = "Activity freq. not recorded"
    ),
    avg_frequency_5y_prior_endpoint_quartile = factor(
      avg_frequency_5y_prior_endpoint_quartile,
      levels = c(
        "Q1(≥20 - <71.67)",
        "Q2(≥71.67 - <80)",
...
final_df[11, 1] <- "Avg. weight 5y prior to endpoint (quartiles)"
final_df[16, 1] <- "Mast cell tumour present"
final_df[19, 1] <- "Gastrointestinal comorbidity 5y prior to endpoint"
final_df[21, 1] <- "Anti-parasites - 5y prior to endpoint (quartiles)"
final_df[26, 1] <- "NSAID used - whole life"
final_df[29, 1] <- "Avg. activity freq. score– 5y prior to endpoint (quartiles)"
final_df[34, 1] <- "Smoke exposure- whole life"
#replace the inf values from the not recorded category in activty freq with numeric values
final_df[33,5] <-"17518242 (0.01-Inf,p=0.951)"
final_df[33,6] <-"17518242"
final_df[33,7]<-"0.01"
...
final_df$category <- factor(final_df$category, 
                        levels = c(">7-<9y","<5y",">5-<7y",">9-<11y",">11-<13y",">13y","F Entire","F Neutered","M Entire","M Neutered","11.15-<21.31kg",">=21.31-<24.66kg",">=24.66-<29.37kg",">=29.37-41.52kg","Weight not recorded","MCT not present","MCT present", "No endpoint data available","GI comorb not present", "GI comorb present","1-2 times",">2-4 times",">4-6 times",">6-20 times","No medications records for this time period", "NSAID not administered", "NSAID administered", "No medications records for lifetime","Q1(≥20 - <71.67)",
                                   "Q2(≥71.67 - <80)","Q3(≥80 - <85)","Q4(≥85 - <100)","Activity freq. not recorded","Not within early life", "Within early life"))
...
p_mid <- 
  ...
  labs(x = "Odds Ratio") +
  coord_cartesian(ylim = c(1, 35), xlim = c(0, 12)) +
...
layout2 <- c(
  patchwork::area(t = 0, l = 0, b = 30, r = 8),  # Make p_left wider# top, left, bottom, right
  patchwork::area(t = 1, l = 9, b = 30, r = 12)    # p_mid occupies a smaller part
)
...
ggsave("C:/Users/ctaylor18/GitHub/GRLS_analyses/Output/logreg_forestplot_casecontrol_numbers.pdf", plot = forest_log, width = 25, height = 10, dpi = 300)

ggsave("C:/Users/ctaylor18/GitHub/GRLS_analyses/Output/logreg_forestplot_casecontrol_numbers.svg", plot = forest_log, width = 25, height = 10, dpi = 300)

ggsave("C:/Users/ctaylor18/GitHub/GRLS_analyses/Output/logreg_forestplot_casecontrol_numbers.tif", plot = forest_log, width = 25, height = 10, dpi = 300)


ggsave("C:/Users/ctaylor18/GitHub/GRLS_analyses/Output/logreg_forestplot.pdf", plot = forest_log, width = 25, height = 10, dpi = 300)

ggsave("C:/Users/ctaylor18/GitHub/GRLS_analyses/Output/logreg_forestplot.svg", plot = forest_log, width = 25, height = 10, dpi = 300)


ggsave("C:/Users/ctaylor18/GitHub/GRLS_analyses/Output/logreg_forestplot.tif", plot = forest_log, width = 25, height = 10, dpi = 300)
```
