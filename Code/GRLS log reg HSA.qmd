...
Explore if can put splits of activity freq in instead of quartiles:
...
```{r}
dependent <- "had_HSA"
explanatory <- c("age_at_final_date_GB","avg_frequency_5y_prior_endpoint_quartile","quartile_anti_parasites_5y_prior_endpoint","NSAID_ever","gastrointestinal","avg_weight_5y_prior_endpoint_quartiles","sex_neuter","smoke_exposure_study_years_early_life")
