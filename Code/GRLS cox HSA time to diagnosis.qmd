...
cohort_abr <- cohort_abr %>%
  mutate(
    avg_weight_5y_prior_endpoint_quartiles = case_when(
      (avg_weight_5y_prior_endpoint_kg_outliers_removed < weight_summary$LQ) ~ "11.15-<21.31kg",
...
#weight
cohort_abr <- cohort_abr%>%
  mutate(avg_weight_5y_prior_endpoint_quartiles = factor(avg_weight_5y_prior_endpoint_quartiles, levels = c("11.15-<21.31kg", ">=21.31-<24.66kg", ">=24.66-<29.37kg", ">=29.37-41.52kg","not_recorded")))
#bcs
cohort_abr <- cohort_abr%>%
