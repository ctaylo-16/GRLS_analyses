...
colnames(cohort)
cohort <- cohort %>%
  dplyr::select(-c(X,had_HSA.y, year_in_study_diagnosis_or_final_record_year.y.x,year_in_study_diagnosis_or_final_record_year.x.x,year_in_study_diagnosis_or_final_record_year.y.y,year_in_study_diagnosis_or_final_record_year.x,year_in_study_diagnosis_or_final_record_year.y))
cohort <- cohort %>%
...
cols_to_keep <- c("subject_id", "MDI_quintile",  "owner_MDI_quintile",
  ...
  "quartile_anti_viral_5y_prior_endpoint", "age_at_final_date_quartiles", "NSAID_5y","NSAID_ever","steroid_5y","steroid_ever","fenbendazole_5y","fenbendazole_ever"
)
...
"malig_cancers_count","benign_cancers_count","all_cancers_count","all_cancers_YN","benign_cancers_YN","malig_cancers_YN","NSAID_5y","NSAID_ever","steroid_5y","steroid_ever","fenbendazole_5y","fenbendazole_ever"  ),
...
-   benign, malig, all - all cancer count and malig count is sig but malig lower AIC/BIC
...
cox_model_45b<- coxph(Surv(survival_time_days, status) ~  avg_weight_5y_prior_endpoint_quartiles + avg_purina_BCS_5y_prior_endpoint_quartiles + avg_frequency_5y_prior_endpoint_quartiles + quartile_anti_parasites_5y_prior_endpoint+sex
 +avg_activity_duration_sy1_2_quartiles +neutered_reason+
use_incense_or_candles_study_years_whole_life+gastrointestinal + all_cancers_count
...
cox_model_45c<- coxph(Surv(survival_time_days, status) ~  avg_weight_5y_prior_endpoint_quartiles + avg_purina_BCS_5y_prior_endpoint_quartiles + avg_frequency_5y_prior_endpoint_quartiles + quartile_anti_parasites_5y_prior_endpoint+sex
 +avg_activity_duration_sy1_2_quartiles +neutered_reason+
use_incense_or_candles_study_years_whole_life+gastrointestinal + malig_cancers_count
...
cox_model_45d<- coxph(Surv(survival_time_days, status) ~  avg_weight_5y_prior_endpoint_quartiles + avg_purina_BCS_5y_prior_endpoint_quartiles + avg_frequency_5y_prior_endpoint_quartiles + quartile_anti_parasites_5y_prior_endpoint+sex
 +avg_activity_duration_sy1_2_quartiles +neutered_reason+
use_incense_or_candles_study_years_whole_life+gastrointestinal + malig_cancers_YN
...
```{r}
explanatory <- c("avg_weight_5y_prior_endpoint_quartiles", "avg_purina_BCS_5y_prior_endpoint_quartiles","avg_frequency_5y_prior_endpoint_quartiles","quartile_anti_parasites_5y_prior_endpoint", "sex", "use_incense_or_candles_study_years_whole_life","avg_activity_duration_sy1_2_quartiles","neutered_reason","gastrointestinal","malig_cancers_count_new")
dependent = 'Surv(survival_time_days,status)'
# Summarize the Cox model output in a table
mod <- cohort_abr_sig %>%
  coxphmulti(dependent,explanatory)%>%
...
```{r}
explanatory <- c("avg_weight_5y_prior_endpoint_quartiles", "avg_frequency_5y_prior_endpoint_quartiles","quartile_anti_parasites_5y_prior_endpoint", "sex","malig_cancers_count")
dependent = 'Surv(survival_time_days,status)'
# Summarize the Cox model output in a table
mod <- cohort_abr_sig %>%
  coxphmulti(dependent,explanatory)%>%
