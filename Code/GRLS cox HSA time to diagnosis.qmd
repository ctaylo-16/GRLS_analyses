...
cohort_abr <- cohort_abr %>%
  mutate(heating_fuel_primary_mode_5yrs_prior = recode(heating_fuel_primary_mode_5yrs_prior, "natural gas" = "natural_gas"))

#recode unknown in the heating/cooking variables to not_recorded
cohort_abr <- cohort_abr %>%
  mutate(heating_fuel_primary_mode_5yrs_prior = recode(heating_fuel_primary_mode_5yrs_prior, "unknown" = "not_recorded"))
cohort_abr <- cohort_abr %>%
  mutate(cooking_fuel_primary_mode_5yrs_prior = recode(cooking_fuel_primary_mode_5yrs_prior, "unknown" = "not_recorded"))
cohort_abr <- cohort_abr %>%
  mutate(heating_fuel_secondary_mode_5yrs_prior = recode(heating_fuel_secondary_mode_5yrs_prior, "unknown" = "not_recorded"))
cohort_abr <- cohort_abr %>%
  mutate(cooking_fuel_secondary_mode_5yrs_prior = recode(cooking_fuel_secondary_mode_5yrs_prior, "unknown" = "not_recorded"))

cohort_abr <- cohort_abr %>%
  mutate(region_mode_5y_prior = recode(region_mode_5y_prior, "unknown" = "not_recorded"))

#recode 0 in neutered_reason to not_neutered and unknown as not_recorded
cohort_abr <- cohort_abr %>%
  mutate(neutered_reason = recode(neutered_reason, "unknown" = "not_recorded"))
cohort_abr <- cohort_abr %>%
