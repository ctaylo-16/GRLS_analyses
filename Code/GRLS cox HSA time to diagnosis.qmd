...
cohort_abr <- cohort %>%
  dplyr::select(c(1,2,4:12,23,225,227:240,244,246:375,378,final_date.y,380:459))
...
-   consider should BCS be reclassed 2 different ways - mode BCS in 5y prior to endpoint AND/OR overweight/underweight/ideal
