...
explanatory = c("MDI_quintile","area_type_mode_5yrs_prior","house_type_mode_5yrs_prior", 
             "water_source_mode_5yrs_prior", "pipes_metal_any_mode_5yrs_prior", "pipes_plastic_any_mode_5yrs_prior", 
             "heating_fuel_primary_mode_5yrs_prior", "cooking_fuel_primary_mode_5yrs_prior", "heating_fuel_secondary_mode_5yrs_prior", 
             "cooking_fuel_secondary_mode_5yrs_prior", "region_mode_5y_prior",  "number_comorbs_present_lifetime", 
             "study_year_first_chronic_inflam", "chronic_inflam_present_5y", "number_comorbs_present_5y", 
...
+ avg_frequency_5y_prior_endpoint_quartiles + number_comorbs_present_5y
, data = cohort_abr_sig)
...
explanatory <- c("avg_weight_5y_prior_endpoint_quartiles" ,"avg_activity_freq_sy3_terciles",
                 "quartile_anti_parasites_5y_prior_endpoint","sex","use_hepa_filter_study_years_rest_of_life","outside_YN_study_years_early_life","avg_frequency_5y_prior_endpoint_quartiles", "number_comorbs_present_5y")
dependent = 'Surv(survival_time_days,status)'
# Summarize the Cox model output in a table
mod <- cohort_abr_sig %>%
  coxphmulti(dependent,explanatory)%>%
...
+ avg_frequency_5y_prior_endpoint_quartiles + chronic_inflam_present_no_min_year
, data = cohort_abr_sig)
...
explanatory <- c("avg_weight_5y_prior_endpoint_quartiles" ,
                 "quartile_anti_parasites_5y_prior_endpoint","sex","use_hepa_filter_study_years_rest_of_life","outside_YN_study_years_early_life","avg_frequency_5y_prior_endpoint_quartiles", "chronic_inflam_present_no_min_year")
dependent = 'Surv(survival_time_days,status)'
# Summarize the Cox model output in a table
mod <- cohort_abr_sig %>%
  coxphmulti(dependent,explanatory)%>%
...
explanatory <- c("avg_weight_5y_prior_endpoint_quartiles" ,
                 "quartile_anti_parasites_5y_prior_endpoint","sex",
                 "outside_YN_study_years_early_life","avg_frequency_5y_prior_endpoint_quartiles")
dependent = 'Surv(survival_time_days,status)'
# Summarize the Cox model output in a table
mod <- cohort_abr_sig %>%
  coxphmulti(dependent,explanatory)%>%
...
```{r}
explanatory <- c("avg_weight_5y_prior_endpoint_quartiles" ,
                 "quartile_anti_parasites_5y_prior_endpoint","sex","outside_YN_study_years_early_life","avg_frequency_5y_prior_endpoint_quartiles")
dependent = 'Surv(survival_time_days,status)'
...
```{r}
int <-coxph(Surv(survival_time_days, status) ~ avg_weight_5y_prior_endpoint_quartiles + quartile_anti_parasites_5y_prior_endpoint + sex+ in.the.garage_YN_study_years_early_life +outside_YN_study_years_early_life
...
-   outside in early life

```{r}
survdiff(Surv(survival_time_months, status) ~ outside_YN_study_years_early_life, data = cohort_abr)

dependent_os = "Surv(survival_time_months, status)"
explanatory = c("outside_YN_study_years_early_life")
