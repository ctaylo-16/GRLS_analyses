...
library(ggplot2)
library(lubridate)
demog <- read.csv(here::here("Data/dog_profile.csv"))


#demog <- demog %>% mutate_all(na_if,"")
# female information
repro_hx_female <- read.csv(here::here("Data/reproductive_history_female.csv"))
spay_details <- read.csv(here::here("Data/details_spay_before_heat.csv"))
...
write.csv(neut_age_M3,here::here("Output/all_cases_all_records_repro.csv"))
...
write.csv(neut_age_M3_abr,here::here("Output/all_cases_all_records_repro.csv"))
...
```{r}
#HSA and repro
write.csv(end_HSA_join,here::here("Output/HSA_case_repro.csv"))


## all endpoints and repro
write.csv(end_join,here::here("Output/endpoints_repro.csv"))


#lymphoma and repro
write.csv(end_lymphoma_join, here::here("Output/lymphoma_case_repro.csv"))
```
