...
```{r}
write.csv(result_combined,"house_location_all.csv")
```
...
write.csv(end_points_all,"endpoints_house_location.csv")

#end points lymphoma
end_points_lymphoma_join <- end_lymphoma %>%
  left_join(result_combined,by="subject_id")
write.csv(end_points_lymphoma_join,"endpoints_lyphoma_house_location.csv")
#end points HSA
end_points_HSA_join <- end_HSA %>%
  left_join(result_combined,by="subject_id")
write.csv(end_points_HSA_join,"endpoints_HSA_house_location.csv")
