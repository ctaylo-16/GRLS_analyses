...
```{r}
enviro_tidy <- read.csv(here::here("Output/lifetime_sleep_smoking_enviro_lifestyle_enviro.csv"))
...
```{r}
dead_dogs <- read.csv(here::here("Data/study_endpoints.csv"))

lymphoma_dogs <- dead_dogs %>%
filter(grepl("lymphoma", tracked_condition, ignore.case = TRUE))
write.csv(lymphoma_dogs,here::here("Output/lymphoma_endpoints.csv"))
...
```{r}
endpoints_house <- read.csv(here::here("Output/endpoints_all_house_location.csv"))
...
```{r}
endpoints_repro <- read.csv(here::here("Output/endpoints_repro.csv"))
...
```{r}
endpoints_comorb<- read.csv(here::here("Output/endpoint_comorbidities.csv"))
...
```{r}
activity <-read.csv(here::here("Output/GRLS_activity_modified_variables_endpoints_outof100.csv"))
...
endpoints_years <- read.csv(here::here("Data/study_endpoints.csv"))
...
```{r}
write.csv(enviro_repro_house_comorb_profile_activity,here::here("Output/endpoints_demog_lifestyle_enviro_comorb.csv"))
```
...
#write.csv(demographics,here::here("Output/RP2_dataset1_lymphoma_demographics.csv"))
```
...
write.csv(demographics_MDI,here::here("Output/RP2_dataset1_lymphoma_demographics.csv"))
```
...
write.csv(early_years,here::here("Output/RP2_dataset2_lymphoma_earlyyears_enviro_lifestyle.csv"))
```
...
write.csv(rest_years,here::here("Output/RP2_dataset3_lymphoma_restyears_enviro_lifestyle.csv"))
```
...
write.csv(other,here::here("Output/RP2_dataset4_lymphoma_comorbidities.csv"))
```
