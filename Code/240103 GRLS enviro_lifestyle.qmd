...
end_points<- read.csv(here::here("Data/data version Feb 2024/study_endpoints.csv"))
...
write.csv(sleep_smoking_enviro_all_final_date,here::here("Output/endpoints_sleep_smoking_enviro_lifestyle_enviro.csv"))
...
#NB change to final file name when file done
write.csv(sleep_smoking_enviro_all_no_endpoints,here::here("Output/allrows_sleep_smoking_enviro_lifestyle_enviro.csv"))
...
write.csv(sleep_smoking_enviro_all_no_endpoints2,here::here("Output/lifetime_sleep_smoking_enviro_lifestyle_enviro.csv"))
```
...
write.csv(HSA_cohort_sleep_smoking_enviro_all_single_row2,here::here("Output/HSA_cohort_lifestyle_exposures.csv"))
```
