...
#### Modifying/organising data from activity

'Early life' (0-2y) activity

For each subject ID across all their records in dataset:

-   calculate an average aerobic duration

-   calculate an average aerobic frequency

-   calculate an average walk frequency

-   calculate an average walk duration
