...
histo_necro <- read.csv(here::here("Data/histology_necropsy_labs.csv"))


neoplasia_conditions <- read.csv(here::here("Data/conditions_neoplasia.csv"))

banked_samples <- read.csv(here::here("Data/banked_samples.csv"))

clinical_labs <- read.csv(here::here("Data/clinical_labs.csv"))

exam_notes <- read.csv(here::here("Data/exam_physical_superficial_mass.csv"))
```
