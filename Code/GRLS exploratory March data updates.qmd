...
folder_path <- here::here("Data/data version Feb 2024")
...
```{r}
write.csv(HSA,here::here("Data/HSA_cases_updated.csv"))

write.csv(neoplasia_dogs,here::here("Data/neoplasia_cases_updated.csv"))

write.csv(non_neoplastic_dogs, here::here("Data/non_neoplasia_cases_updated.csv"))
```
